...
/**
 * This is abstract Hazelcast event listener for entry/item/message events.
 * 
...
public abstract class AbstractHazelcastEventListener {
	...
	protected void sendMessage(EventObject event, InetSocketAddress socketAddress,
		...
		if (CacheListeningPolicyType.ALL == cacheListeningPolicyType
			...
			getHazelcastInboundChannelAdapter().sendMessage(
	...
	private boolean isEventAcceptable(Set<SocketAddress> localSocketAddressesSet,
			InetSocketAddress socketAddressOfEvent) {
