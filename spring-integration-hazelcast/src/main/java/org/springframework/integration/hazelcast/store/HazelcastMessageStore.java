 ...
 */
public class HazelcastMessageStore extends AbstractKeyValueMessageStore implements InitializingBean{
	...
	public void afterPropertiesSet() throws Exception {
		if(this.map == null){
			this.map = this.hazelcastInstance.getMap(MESSAGE_STORE_MAP_NAME);
		}
	}
