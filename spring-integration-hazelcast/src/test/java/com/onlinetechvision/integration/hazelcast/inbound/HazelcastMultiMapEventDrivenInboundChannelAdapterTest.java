...
@ContextConfiguration(locations={"/HazelcastMultiMapEventDrivenInboundChannelAdapterTest-context.xml"})
@DirtiesContext(classMode = ClassMode.AFTER_CLASS)
public class HazelcastMultiMapEventDrivenInboundChannelAdapterTest {
	...
	@Resource
	private MultiMap<Integer, User> edMultiMap1;
		
	@Resource
	private MultiMap<Integer, User> edMultiMap2;
	
	@Resource
	private MultiMap<Integer, User> edMultiMap3;
	
	@Test
	public void testEventDrivenForOnlyADDEDEntryEvent() {
		edMultiMap1.put(1, new User(1, "TestName1", "TestSurname1"));
		...
		Assert.assertEquals("edMultiMap1", ((EntryEvent<?, ?>)msg.getPayload()).getName());
	...
	public void testEventDrivenForOnlyREMOVEDEntryEvent() {
		edMultiMap2.put(1, new User(1, "TestName1", "TestSurname1"));
		edMultiMap2.put(2, new User(2, "TestName2", "TestSurname2"));
		...
		Assert.assertEquals("edMultiMap2", ((EntryEvent<?, ?>)msg.getPayload()).getName());
	...
	public void testEventDrivenForALLEntryEvent() {
		edMultiMap3.put(1, new User(1, "TestName1", "TestSurname1"));
		Message<?> msg = edMultiMapChannel3.receive(2_000);
		verify(msg, "edMultiMap3", EntryEventType.ADDED);
		
		edMultiMap3.put(1, new User(1, "TestName1", "TestSurnameUpdated"));
		...
		edMultiMap3.put(2, new User(2, "TestName2", "TestSurname2"));
		msg = edMultiMapChannel3.receive(2_000);
		verify(msg, "edMultiMap3", EntryEventType.ADDED);
