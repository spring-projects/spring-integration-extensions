## **_This project has been absorbed by Spring Integration Core starting with version 5.3. Please consult its [Reference Manual](https://docs.spring.io/spring-integration/docs/current/reference/html) for the actual documentation. This project is only in a maintenance, bug fixing state._**
