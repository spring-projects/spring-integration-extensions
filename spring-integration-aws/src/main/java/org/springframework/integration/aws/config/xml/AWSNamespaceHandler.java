...
import org.springframework.integration.aws.s3.config.xml.AmazonS3OutboundGatewayParser;
...
public class AWSNamespaceHandler extends
	...
	public void init() {
		...
		this.registerBeanDefinitionParser("s3-outbound-gateway", new AmazonS3OutboundGatewayParser());
	}
