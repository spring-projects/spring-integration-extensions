...
public class KafkaConsumerContextParserPropertyTopicTests<K, V> {
	...
	public void testConsumerContextConfiguration() {
		...
		final ConsumerMetadata<K, V> cm = appContext.getBean("consumerMetadata___consumerGroupId_", ConsumerMetadata.class);
